...
export class DataService {
  ...
  constructor() {
    ...
    this.contractAddress = '0x7614aD4B540Ac6B84e2bA4613472959DdB0Bd039';
    this.ABI = [
      {
        inputs: [
          {
    ...
    let provider = new ethers.providers.JsonRpcProvider(this.HttpProvider);
    this.erc20 = new ethers.Contract(this.contractAddress, this.ABI, provider);
    this.totalSupply = this.erc20.totalSupply();
    this.tokenSymbol = '';
  }
